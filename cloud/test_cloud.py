...
def check_ticket(channel):
    ...
    ticket_status=stub.checkTicket(pb2.checkTicketInputs(ticket_id="989306",device_id=device_id))
    print(ticket_status)
...
def check_ticket_off(channel):
    ...
    device_id = "Lamverde32"
    stub = pb2_grpc.SmartBusStub(channel)
    ticket_status=stub.checkTicketOff(pb2.checkTicketInputs(ticket_id="989306",device_id=device_id))
    print(ticket_status)
    return str(ticket_status)
